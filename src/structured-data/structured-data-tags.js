...
function articleSectionObj(story) {
  if (story["story-template"] !== "video") {
    return {
      articleSection: get(story, ["sections", "0", "display-name"], "")
    };
  }
}
...
function generateArticleData(
  ...
  return Object.assign(
    {},
    generateCommonData(structuredData, story, publisherConfig),
    {
    ...
    if (structuredData.enableNewsArticle) {
      return ldJson(
        ...
        Object.assign(
          {},
          articleData,
          generateNewsArticleData(structuredData, story, publisherConfig)
        )
      );
    }
  }
  ...
  function storyTags() {
    if (
      ...
      return ldJson(
        ...
        Object.assign(
          {},
          generateLiveBlogPostingData(structuredData, story, publisherConfig)
        )
      );
    }
    ...
    if (structuredData.enableVideo && story["story-template"] === "video") {
      return ldJson(
        "VideoObject",
        generateVideoArticleData(structuredData, story, publisherConfig)
      );
    }
