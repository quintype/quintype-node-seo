...
function pickImageFromStory(story) {
  ...
  const socialAlternateHeroImageS3Metadata =
    alternateSocialMetadata || alternateHomeMetadata || story["hero-image-metadata"];

  const socialAlternateHeroImageS3Key = alternateSocialS3Key || alternateHomeS3Key || story["hero-image-s3-key"];
