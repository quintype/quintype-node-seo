...
describe("StructuredDataTags", function () {
  ...
  describe("author metadata normalization", function () {
    it("emits author metadata correctly (image, jobTitle, description, knowsAbout, sameAs) in Article schema", function () {
      const authorData = [
        {
          id: 482995,
          name: "Greeshma",
          slug: "greeshma",
          "avatar-url": "https://images.assettype.com/avatar.jpg",
          metadata: {
            jobTitle: "Senior Editor",
            description: "Experienced political journalist",
            knowsAbout: "Politics, Economy",
          },
          social: {
            twitter: {
      ...
      const story = sampleStoryData("text", [], authorData);
      ...
      assertContains('"image":"https://images.assettype.com/avatar.jpg"', tags);
      assertContains('"jobTitle":"Senior Editor"', tags);
      assertContains('"description":"Experienced political journalist"', tags);
      assertContains('"knowsAbout":["Politics","Economy"]', tags);
      assertContains('"sameAs":["https://twitter.com/greeshma"]', tags);
    });
  });
