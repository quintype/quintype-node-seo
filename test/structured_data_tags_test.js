  ...
  return {
    data: {
      story: {
        ...
        headline:
          "Personalise or perish - Why publishers need to use personalised content",
        slug:
          "politics/2018/02/28/personalise-or-perish---why-publishers-need-to-use-personalised-content",
        ...
        summary:
          "Personalised content marketing is the slayer weapon in this war for attention and engagement.",
        "hero-image-s3-key":
...
describe("StructuredDataTags", function() {
  ...
  describe("with news article data ", function() {
      ...
      const cards = [
        {
          ...
          "story-elements": [
            ...
            {
              "image-s3-key":
                "bloombergquint/2018-07/99423a77-d39a-4803-94c9-1bdc33f95cc6/OI_July_4.PNG",
              type: "image"
            },
            {
              type: "text",
    ...
    it("puts the`NewsArticle` and removes `Article` when enableNewsArticle value is `withoutArticleSchema` in theme-attributes config", function() {
      ...
      const expectedString =
        '"@type":"Article","@context":"http://schema.org"}';
    ...
    it("generate Structured DataTags for Movie Entities", function() {
      const movieEntity = {
        ...
        photo: [
          {
            key:
              "vikatandry2/2019-03/97ff1197-f723-4745-8394-442c0f1b1dfa/0.jpg",
            url:
              "http://thumbor-stg.assettype.com/vikatandry2/2019-03/97ff1197-f723-4745-8394-442c0f1b1dfa/0.jpg",
            caption: "ABCD",
            metadata: {
              "mime-type": "image/jpeg"
            },
