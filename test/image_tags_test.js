...
describe('ImageTags', function() {
  ...
  it("has facebook tags resized correctly", function() {
    ...
    const string = getSeoMetadata(seoConfig, config, 'story-page', {data: {story: story}}, {})
    assertContains('<meta name="og:image" content="https://thumbor.assettype.com/my%2Fimage.png?rect=0%2C0%2C2400%2C1260&amp;w=1200&amp;auto=format%2Ccompress"/>', string);
    assertContains('<meta name="og:image:width" content="1200"/>', string);
    assertContains('<meta name="og:image:height" content="630"/>', string);
  })
});
