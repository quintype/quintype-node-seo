...
describe('ImageTags', function() {
  ...
  it("has facebook tags resized correctly", function() {
    ...
    const string = getSeoMetadata(seoConfig, config, 'story-page', {data: {story: story}}, {})
    assertContains('<meta property="og:image" content="https://thumbor.assettype.com/my%2Fimage.png?rect=0%2C0%2C2400%2C1260&amp;w=1200&amp;auto=format%2Ccompress&amp;ogImage=true"/>', string);
