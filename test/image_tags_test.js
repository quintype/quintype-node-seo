...
describe("ImageTags", function() {
  ...
  it("gets the twitter tags", function() {
    ...
    assertContains(
      '<meta name="twitter:image" content="https://thumbor.assettype.com/my%2Fimage.png?w=1200&amp;auto=format%2Ccompress"/>',
      string
    );
  });
  ...
  it("has facebook tags resized correctly", function() {
    ...
    assertContains(
      '<meta property="og:image" content="https://thumbor.assettype.com/my%2Fimage.png?rect=0%2C0%2C2400%2C1260&amp;w=1200&amp;auto=format%2Ccompress"/>',
      string
    );
  ...
  it("gets card image values instead of story image values on card share", function() {
    ...
    assertContains(
      '<meta name="twitter:image" content="https://thumbor.assettype.com/my%2Fcard%2Fimage.jpg?w=1200&amp;auto=format%2Ccompress"/>',
      string
    );
  });
