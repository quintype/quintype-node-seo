...
describe("TextTags", function() {
  describe("Home And Section Page", function() {
    it("gets the homepage config", function() {
      ...
      const config = {
        "seo-metadata": [
          { "owner-type": "home", data: { "page-title": "Foobar" } }
        ]
      };
    ...
    it("generates tags for custom static pages", function() {
      ...
      assertContains(
        '<meta name="description" content="services-page-desc"/>',
        string
      );
      assertContains(
        '<meta name="title" content="services-page-title"/>',
        string
      );
      assertContains(
        '<meta name="keywords" content="services-page1,services-page2"/>',
        string
      );
    });
    ...
    it("gets the meta config for the section when section metadata is available", function() {
      ...
      assertContains(
        '<meta name="description" content="This is a demo page for Quintype"/>',
        string
      );
      assertContains(
        '<meta name="title" content="Quintype Demo Homepage Meta"/>',
        string
      );
      assertContains(
        '<meta name="keywords" content="quintype, demo"/>',
        string
      );
    });
    ...
    it("twitter title will be headline if its a story page", function() {
      ...
      assertContains(
        '<meta name="twitter:title" content="story-headline"/>',
        string
      );
      assertContains(
      ...
      assertContains(
        '<link rel="canonical" href="http://foo.com/story-slug"/>',
        string
      );
    });
  });
  ...
  describe("Story Page", function() {
    it("Generates SEO tags for a story page", function() {
      ...
      assertContains('<meta name="title" content="Foobar"/>', string);
      assertContains(
        '<meta name="description" content="Some Foobar"/>',
        string
      );
      assertContains('<meta name="keywords" content="Footag"/>', string);
      assertContains(
        '<link rel="canonical" href="http://foo.com/politics/awesome"/>',
        string
      );
    });
    ...
    it("Generates SEO tags for a card in story page", function() {
      ...
      assertContains(
        '<meta name="description" content="share-card-description"/>',
        string
      );
      assertContains('<meta name="keywords" content="Footag"/>', string);
      assertContains(
    ...
    it("Overrides the canonical url", function() {
      ...
      assertContains(
        '<link rel="canonical" href="http://foobar.com/mystory"/>',
        string
      );
    });
    ...
    it("Overrides the canonical meta title and description", function() {
      ...
      const story = {
        seo: {
          "meta-title": "Foobar",
          "meta-description": "Some Foobar",
          "meta-keywords": ["Footag"]
        },
        tags: []
      };
      const string = getSeoMetadata(
    ...
    it("Can generate news tags", function() {
      ...
      assertContains(
        '<link rel="standout" href="http://foo.com/politics/awesome"/>',
        string
      );
    });
  });
  ...
  describe("Getting the title", function() {
    ...
    it("can also get the title if passed in from data", function() {
      ...
      assert.equal(
        "My Title",
        seo.getTitle(config, "home-page", { title: "My Title" }, {})
      );
      assert.equal(
        "My Title",
        seo.getTitle(config, "home-page", { data: { title: "My Title" } }, {})
      );
    });
  });
  ...
  describe("Tag Page", function() {
    it("Generates SEO tags for a tag page", function() {
      ...
      assertContains('<meta name="keywords" content="Footag"/>', string);
      assertContains(
        '<link rel="canonical" href="http://foo.com/Foopath"/>',
        string
      );
    });
